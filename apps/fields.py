from numerous import field, app
...
class FieldApp:
    ...
    my_text_field_with_default_value: str = field(label="Text Field Label", default="My text field")
    my_number_field_with_default_value: float = field(label="Number Field Label", default=42.0)
